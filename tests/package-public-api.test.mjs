...
const expectedRuntimeExports = {
  ...
  "@civaapple/qi-agent/capability": [
    "ASK_MODE_TOOLS", "CODING_LEASE_PACK", "InMemoryCapabilityBroker",
    "InMemoryCredentialBroker", "PERMISSION_MODES", "PLAN_MODE_EXTRA_TOOLS", "SAFE_LEASE_PACK",
    "SESSION_MODES",
    "buildApprovalPattern", "evaluateApprovalPolicy", "formatModeLabel", "formatPermissionLabel",
    "isPermissionMode", "isToolAllowedInMode", "leasePackForPermissionMode",
    "mergeRedactionSummaries", "modeAllowsIntent", "nextPermissionMode", "nextSessionMode",
    "parseApprovalPattern", "patternKey", "patternMatches", "permissionAutoAcceptsInLease",
    "permissionModeDescription", "permissionSuppressesAskQuestion",
    "redactSensitiveText", "redactSensitiveValue", "rememberApproval", "serializeApprovalPattern",
    "toolsForMode",
  ],
  ...
  "@civaapple/qi-node/tools": [
    ...
    "resolveShellExecutable", "resolveWorkspaceEntry", "resolveWorkspacePath", "runToolProcess",
  ...
  "@civaapple/qi-node/sandbox": [
    "DEFAULT_SANDBOX_WRAPS", "HostProcessSandbox", "SrtCliProcessSandbox",
    "SrtWinProcessSandbox", "WinLowIntegritySandbox", "clearSandboxSmokeCache",
    "ensureMachineReadableSrtWin", "probeSrtAvailable", "resolveSandboxBackend",
