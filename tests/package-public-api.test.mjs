...
const expectedRuntimeExports = {
  ...
  "@civaapple/qi-node/tools": [
    ...
    "ToolOutputError", "ToolRegistry", "artifactTool", "assertSensitiveContentAllowed", "builtinTools", "createFetchTool",
    ...
    "formatCmdVersionLabel", "gitTool", "isRegularFile", "isSensitiveWorkspacePath", "joinWorkspaceRelative", "listTool", "loadVerificationProfiles", "mountsFromContext",
    "moveTool", "networkResource", "normalizeWorkspaceRelativePath", "platformShellCandidates", "prepareVerificationProfiles", "prewarmTrustedExecutables", "probeShellProfiles",
    ...
    "searchTool", "sensitivePathGrantsFromContext", "sensitivePathPolicyFromContext", "shellProfileResource", "shellTool", "treeTool", "verificationResource",
    "textResponseLimitBytes", "windowsCommandInvocation", "writeTool", "writeVerificationManifest",
  ],
  "@civaapple/qi-node/media": [
    ...
    "detectImageUrlCandidates", "normalizeImageMediaType", "prepareImageBytes", "sniffImageMediaType",
  ],
  "@civaapple/qi-tui": [
