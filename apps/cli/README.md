...
| `/goal [prompt]` | Session-local 追寻: `/goal <objective>` creates a Goal and starts the first bound Run; bare `/goal` opens a status + actions hub (Continue / Pause / Resume / Cancel). Completion still requires evidence |
